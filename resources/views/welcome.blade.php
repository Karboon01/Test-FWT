        ...
        <div class="flex flex-col w-[30%] gap-5">
            ...
            <form action="{{ route('createTask') }}" method="get">
                ...
                <div class="mb-5">
                    ...
                    <textarea id="descr" type="text" name="descr" required 
                        class="bg-neutral-700 border border-neutral-600 text-white text rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-neutral-400 resize-none"
